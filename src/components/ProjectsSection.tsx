...
const projects: Project[] = [
  ...
  {
    id: 2,
    title: 'Twitter Profiles Analyzer',
    description: 'Tool to analyze Twitter developer profiles and extract insights, built with React and Twitter API integration.',
    category: 'development',
    image: 'https://images.unsplash.com/photo-1611162617213-7d7a39e9b1d7',
    tags: ['React', 'Twitter API', 'Data Analysis', 'JavaScript'],
    links: {
      github: 'https://github.com/TristanBrian/twitter-profiles-analyzer',
    },
    icon: <Database />,
  },
  {
    ...
    description: 'Implementation of secure CI/CD pipelines with automated security scanning and vulnerability assessment.',
    category: 'cybersecurity',
    image: 'https://images.unsplash.com/photo-1607799279861-4dd421887fb3',
    tags: ['DevOps', 'CI/CD', 'Security', 'Docker'],
    links: {
      github: 'https://github.com/TristanBrian/secure-devops-pipeline',
    },
    icon: <Server />,
  },
  {
    ...
    description: 'Comprehensive framework for implementing Zero Trust network security in enterprise environments.',
    category: 'cybersecurity',
    image: 'https://images.unsplash.com/photo-1558494949-ef010cbdcc31',
    tags: ['Zero Trust', 'Network Security', 'Python', 'Security Models'],
    links: {
      github: 'https://github.com/TristanBrian/network-security-framework',
    },
    icon: <Shield />,
  },
  {
